<?php
/*
Plugin Name: Visual Composer Extensions - iHover
Description: Add 20 circle and 15 square CSS3 transition of hover thumbnail to your Visual Composer.
Author: Sike
Version: 1.2
...
if (!class_exists('VC_Extensions_iHover')) {
    ...
    class VC_Extensions_iHover {
        function VC_Extensions_iHover() {
          ...
          wpb_map( array(
            ...
            "base" => "cq_vc_ihover",
            "class" => "wpb_cq_vc_ihover",
            "controls" => "full",
            "icon" => "icon-wpb-vc_ihover_cq",
            ...
            "params" => array(
              ...
              array(
                ...
                "param_name" => "margin",
                "value" => __("0 16 0 0", 'vc_ihover_cq'),
                "description" => __("Magin of each thumbnail.", 'vc_ihover_cq')
              ),
              array(
                "type" => "textfield",
                "holder" => "",
  ...
  function vc_ihover_cq_notice(){
    $plugin_data = get_plugin_data(__FILE__);
    echo '
    <div class="updated">
      <p>'.sprintf(__('<strong>%s</strong> requires <strong><a href="http://codecanyon.net/item/visual-composer-page-builder-for-wordpress/242431?ref=sike" target="_blank">Visual Composer</a></strong> plugin to be installed and activated on your site.', 'vc_ihover_cq'), $plugin_data['Name']).'</p>
    </div>';
  }
  if (!defined('ABSPATH')) die('-1');

  // comment below line if your VC come from a theme, and copy the last line to your theme's function.php
  if (!defined('WPB_VC_VERSION')) {add_action('admin_notices', 'vc_ihover_cq_notice'); return;}
